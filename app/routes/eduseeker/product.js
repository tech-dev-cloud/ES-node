    ...
    joiSchemaForSwagger: {
      ...
      body: {
        ...
        type: JOI.string()
          ...
          .description('1->PDF, 2->quiz, 3->books, 4-> course'),
  ...
  },
  {
    ...
    joiSchemaForSwagger: {
      ...
      body: {
        ...
        removed_questions: JOI.array().items(
          JOI.object({
            product_id: routeUtils.validation.mongooseId,
            question_id: routeUtils.validation.mongooseId,
          })
  ...
  },
  {
    ...
    joiSchemaForSwagger: {
      ...
      body: {
        message: JOI.string(),
        type: JOI.string()
          .valid(['product_review', 'lecture_query', 'feedback'])
          .required(),
  ...
  },
  {
    ...
    joiSchemaForSwagger: {
      body: {
        ...
        priority: JOI.number(),
        message: JOI.string(),
        approved_type: JOI.number()
          .valid([1, 2, 3])
          .description('1=>Top, 2=>middle, 3=>low'),
        id: routeUtils.validation.mongooseId,
        email: JOI.string(),
      },
      group: 'Reviews',
